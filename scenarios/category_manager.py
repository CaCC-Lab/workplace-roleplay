...
class ScenarioCategoryManager:
    ...
    def _get_warning_message(self, scenario_data: Dict[str, Any]) -> str:
        ...
        return "このシナリオは職場のハラスメント防止を目的とした研修コンテンツです。" "デリケートな内容を含む場合がありますので、ご自身の判断で学習を進めてください。"
    ...
    def get_categorized_summary(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        return {"regular_communication": regular_summaries, "harassment_prevention": harassment_summaries}
