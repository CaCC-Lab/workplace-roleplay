...
class Config(BaseSettings):
    ...
    SECRET_KEY: str = Field(default="default-secret-key-change-in-production", alias="FLASK_SECRET_KEY")
...
class DevelopmentConfig(Config):
    ...
    def set_dev_secret_key(cls, v):
        ...
        if v in ["dev-secret-key-for-development-only", "default-secret-key-change-in-production"]:
            warnings.warn(
                "Using default SECRET_KEY in development. Never use this in production!", UserWarning, stacklevel=2
            )
