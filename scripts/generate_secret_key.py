...
from config.security_utils import generate_secure_secret_key, is_secure_secret_key, recommend_secret_key_improvements
...
""",
    ...
    parser.add_argument(
        "-l", "--length", type=int, default=64, help="Key length in characters (default: 64, minimum: 32)"
    )

    parser.add_argument("-c", "--check", type=str, help="Check if the provided key is secure")

    parser.add_argument("-n", "--count", type=int, default=1, help="Number of keys to generate (default: 1)")

    parser.add_argument("--env-format", action="store_true", help="Output in .env file format")
