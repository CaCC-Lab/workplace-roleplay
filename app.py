...
※重要: 以下の評価は全て「あなた」（ユーザー）の視点で記述してください。
「あなた」=ユーザー、「相手」または「部下」=AIロールプレイヤーです。
例: ✅「あなたの指示が明確でした」 ❌「相手の指示が明確でした」
...
※重要: 以下の評価は全て「あなた」（ユーザー）の視点で記述してください。
「あなた」=ユーザー、「相手」または役職名=AIロールプレイヤーです。
例: ✅「あなたの説明が分かりやすかった」 ❌「相手の説明が分かりやすかった」
...
※重要: 以下の評価は全て「あなた」（ユーザー）の視点で記述してください。
「あなた」=ユーザー、「相手」=AIロールプレイヤーです。
例: ✅「あなたの話題選びが適切でした」 ❌「相手の話題選びが適切でした」

🎯 AIによる評価システム：
📈 雑談効果スコア（/100点）：あなたの関係構築効果度
🌟 コミュニケーション強み（2点）：
...
評価視点：あなたの相手理解力・感情配慮・関係構築能力・場面適応性を重視
